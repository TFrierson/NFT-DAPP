...
import abi from "./contracts/DeafGalaxy.json";
import nftMetaData from "./nft_metadata.json";

function App() {

  //INSERT YOUR CONTRACT ADDRESS HERE
  const contractAddress = '0xc808a0AF0F009a384E90481D7Bc4a77eFc0c7B46';
  ...
  const mintToken = async (tokenId) => {
    try {
      if (window.ethereum) {
        ...
        const metadataURI = `https://gateway.pinata.cloud/ipfs/QmXJccX39MTrsM94wBeeuLyJsMPwfGqr33nhd5yEh4kGTu/${tokenId}.json`
